...
describe("Home", () => {
  ...
  it("ensure about text consistency", () => {
    ...
    expect(screen.getByTestId("about")).toHaveTextContent(
      "Além de um cara legal, trabalho criando soluções mobile utilizando Swift e React Native (também com muito interesse em UI/UX). Levo a vida devagar curtindo muito 🐶 🎮 🍿 ☕"
    );
  });
